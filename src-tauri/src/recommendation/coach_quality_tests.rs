#[cfg(test)]
mod tests {
    use crate::recommendation::coach_quality::*;
    ...
    fn engine_pipeline_coaching_passes_audit() {
        ...
        use crate::recommendation::engine::compute_recommendations;
    ...
    fn champ(id: i64, key: &str) -> crate::db::champion_repo::ChampionRecord {
        crate::db::champion_repo::ChampionRecord {
            champion_id: id,
            key: key.into(),
            name: key.into(),
            title: String::new(),
    ...
    fn mastered(id: i64) -> crate::db::mastery_repo::MasteryRow {
    ...
    fn enemy(id: u32, pos: &str) -> crate::lcu::session::TeamSlot {
        crate::lcu::session::TeamSlot {
            cell_id: 5,
            champion_id: id,
            intent_champion_id: 0,
    ...
    fn sess(
        my_pos: &str,
        their_team: Vec<crate::lcu::session::TeamSlot>,
        queue_id: u32,
        pick_order: u8,
    ) -> crate::lcu::session::ChampSelectState {
        crate::lcu::session::ChampSelectState {
            my_cell_id: 0,
            local_player: crate::lcu::session::TeamSlot {
                cell_id: 0,
                champion_id: 0,
                intent_champion_id: 0,
    ...
    fn run_pipeline(
        session: crate::lcu::session::ChampSelectState,
        champions: Vec<crate::db::champion_repo::ChampionRecord>,
        mastery: Vec<crate::db::mastery_repo::MasteryRow>,
    ) -> Vec<crate::recommendation::models::Recommendation> {
        use crate::recommendation::draft_brain::{
            local_rules_model_pack, local_seed_data_pack, upgrade_recommendations_with_context,
        };
        use crate::recommendation::draft_iq::DraftKnowledgeBase;
    ...
    fn assert_all_clean(recs: &[crate::recommendation::models::Recommendation]) {
