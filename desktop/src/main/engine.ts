...
export interface CoreModule {
  ...
  lobby_scouting_json(input: string): string;
...
export class Engine {
  ...
  /** {pools, all_champions} → ScoutingReport. */
  lobbyScouting<TOut = unknown>(input: unknown): TOut {
    return this.call(this.core.lobby_scouting_json, input);
  }
